...
# Edit these to match your system settings
        ...
        # PID file
        PIDFILE=/home/patrol/zabbix/$BINARY_NAME.pid
...
start() {
        if [ $RUNNING -eq 1 ]
                ...
                touch /home/patrol/zabbix/$BINARY_NAME
        fi
}
...
stop() {
        ...
        RETVAL=$?
        echo
        [ $RETVAL -eq 0 ] && rm -f /home/patrol/zabbix/$BINARY_NAME
        RUNNING=0
}
